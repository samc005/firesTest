...
if tab == "Home":
    # Click
    st.markdown("""
        <h1 style='color: #FF5733; font-family: Tahoma; font-size: 50px; transition: 2.0s ease-in;'>FireWatch</h1>
        <p style='color: #E28743; font-family: Tahoma; font-size: 20px; text-align: center; padding-right: 10px; transition: 2.0s ease-in;'>&nbsp;A Real-Time Wildfire Predictor</p>
    """, unsafe_allow_html=True)
    st.write('')
    st.write('')
